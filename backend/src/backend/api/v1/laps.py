...
def list_laps(session_key: int):
    ...
    # Build query conditionally instead of using f-string interpolation
    base_query = """
        SELECT
    ...
    if driver:
        base_query += " AND lt.driver_number = :driver"
        params["driver"] = driver
    
    base_query += " ORDER BY lt.driver_number, lt.lap_number"
